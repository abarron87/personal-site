...
// TreeCategoriesAutoSuggest.Collections.SelectedCategories = Backbone.Collection.extend({
// 	model: TreeCategoriesAutoSuggest.Models.Category
// });
TreeCategoriesAutoSuggest.Models.Category = Backbone.Model.extend({
	defaults: {
		id: "",
		name: "",
		path: "",
